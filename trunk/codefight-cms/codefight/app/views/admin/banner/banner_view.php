      ...
      <tr>
		...
		<table border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td class="main">
                <input type="file" name="banner_image" id="banner_image" value="<?php echo $banner['banner_title'];?>" />
          ...
          <tr>
            ...
            <td class="main">
                <textarea name="banner_html_text" id="banner_html_text"><?php echo $banner['banner_html_text'];?></textarea>
            </td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          ...
          <tr>
            <td class="main">
                ...
                <br>
                <small><!-- (dd/mm/yyyy) -->(dd/mm/yyyy)</small>
            </td>
          ...
          <tr>
            ...
            <td class="main">
                ...
                , <?php echo __('or at'); ?>
                <br>
                <input type="text" name="expire_impressions" id="expire_impressions" value="<?php echo $banner['expire_impressions'];?>" maxlength="7" size="7" />
                <?php echo __('impressions/views'); ?>
                <br>
                , <?php echo __('or at'); ?>
                <br>
                <input type="text" name="expire_clicks" id="expire_clicks" value="<?php echo $banner['expire_clicks'];?>" maxlength="7" size="7" />
                <?php echo __('clicks'); ?>.
		   </td>
          </tr>
		  <tr>
			...
			<td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
			  <tr>
				...
				<td class="main" valign="top" nowrap>
				    <input name="submit" id="submit" type="submit" value="<?php echo __('submit'); ?>" />
